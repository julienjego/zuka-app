class ProductScores {
    constructor(nutriscore, novascore, ecoscore) {
...
export function getScores(data) {
    const scores = new ProductScores(data.product.nutriscore_grade, data.product.nova_group, data.product.ecoscore_grade);
